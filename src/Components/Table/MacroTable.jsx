    ...
    <Table>
      <Thead>
        <Tr className="flex items-stretch flex-1  ">
          <Th>Symbol</Th>
          <Th>Avg Daily Realised Ops</Th>
          <Th>
            Market Priced Event <br /> Weight*
          </Th>
          <Th>
            Market Implied Add On  (Vol)
          </Th>
          <Th>
            Market Implied Add On <br /> (bps)
          </Th>
          <Th>
            Historic return add On <br />
            (bps)
          </Th>
          <Th>T-Stats(2y)</Th>
          <Th> </Th>
      ...
      <Tbody>
        {/* <Tr className="  border-b border-[#C7C7Cb] h-[47px]  flex  items-start self-stretch">
          <Td>Payrolls</Td>
          <Td>job</Td>
          <Td>20/10/2014</Td>
          <Td>1.65</Td>
        ...
        {dataArray.map((row, index) => (
          <Tr
            key={index}
            className="border-b border-[#C7C7Cb] h-[47px] flex items-start self-stretch"
          >
            <Td>{row.symbol}</Td>
